...
public class EmailService {
    ...
    public String sendUniqueInvitationForGeneralSurveyUsers(String emails) {
        try {
            //  SimpleMailMessage message = new SimpleMailMessage();
            MimeMessage mimeMessage = emailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(mimeMessage, true);
            helper.setSubject("Invitation to the survey");
            String url = "http://54.213.196.21:3000/" + 21;
            create_QR(url);
            ...
            System.out.printf("Email has been sent to", emails);
            System.out.printf("here is URL", url);
            //}
    ...
    public void create_QR(String content) {
        ...
        try {
            FileOutputStream fOut = new FileOutputStream(new File("src/main/resources/image.png"));
